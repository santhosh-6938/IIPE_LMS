...
async function testCoTeacherFunctionality() {
  try {
    // Connect to MongoDB
    await mongoose.connect(process.env.MONGODB_URI);
    console.log('Connected to MongoDB');

    console.log('\n=== Testing Co-Teacher Functionality ===\n');
    ...
    // Test 3: Test co-teacher invitation
...
module.exports = testCoTeacherFunctionality;
